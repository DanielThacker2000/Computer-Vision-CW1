...
switch lower(FEATURE)    
    ...
    case 'colour histogram'
        ...
        train_image_feats = my_colour_indexing(train_image_paths, num_bins, normalize, colour_space);
        test_image_feats  = my_colour_indexing(test_image_paths, num_bins, normalize, colour_space);
end
...
switch lower(CLASSIFIER)    
    ...
    predicted_categories = my_knn_classifier(train_image_feats, train_labels, test_image_feats, 4);
end
